...
declare function ndarray<D extends ndarray.Data<D>>(
    data: D[], // D
    shape?: number[],
    stride?: number[],
    offset?: number,
...
declare namespace ndarray {
    ...
    interface NdArray<D extends Data<D>> {
        data: Data<D>; // D and blow D
        shape: number[];
        stride: number[];
        offset: number;
        dtype: DataType<Data<D>>;
        size: number;
        order: number[];
        dimension: number;
        get(...args: number[]): Value<Data<D>>;
        set(...args: number[]): Value<Data<D>>;
        index(...args: number[]): Value<Data<D>>;
